...
const submitCode = async () => {
  ...
  try {
    const response = await axios.post('http://127.0.0.1:8080/GenerateCodeSignature', {
      code: code.value
    }, {
      headers: {
...
<template>
  <div>
    <Tip>
      <p>生成代码签名：提取代码中的函数和类签名，生成简洁的接口文档。</p>
      <p>你需要提交的参数有：Code。</p>
    </Tip>
    ...
    <el-row :gutter="20" class="control-row" align="middle">
      <el-col :span="12">
        <el-steps :active="activeStep" align-center>
          ...
          <el-step title="Step 2" description="已准备好生成代码签名" />
        </el-steps>
      </el-col>
